    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      {contest.cover_image && (
        <div className="relative h-[28rem] sm:h-[24rem] md:h-[32rem] lg:h-[36rem] xl:h-[40rem] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-[#0A0A0A]"></div>
                      ...
                      >
                        <div className="text-center">
                          <div className={`w-12 h-12 ${
                            ...
                            rank === 5 ? 'bg-gradient-to-br from-purple-400 to-purple-600' :
                            'bg-gradient-to-br from-slate-400 to-slate-600'
                          } rounded-full flex items-center justify-center border border-white/20 mb-3 mx-auto transition-all duration-300`}>
                            {rank === 1 ? (
                          ...
                          <div className="bg-black/60 backdrop-blur-sm rounded-lg p-3 min-w-[120px] border border-white/20 transition-all duration-300">
                            <div className="text-white font-bold text-sm transition-all duration-300">
                              {prizeText}
                            </div>
                            <div className="text-white/80 text-xs leading-tight text-center transition-all duration-300">
                              {prizeAmount ? `$${formatNumber(prizeAmount)}` : ''}
                            </div>
                          </div>
                        </div>
